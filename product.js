...
function show_products(list){
    ...
    for(let i=0;i<list.length;i++){
        ...
        h4.innerHTML=list[i]['title']

        let p=document.createElement('p');
        h4.innerHTML=list[i]['description']
